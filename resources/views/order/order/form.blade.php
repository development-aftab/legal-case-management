<div class="form-group {{ $errors->has('case_file_id') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="case_file_id" type="number" id="case_file_id" value="{{ $order->case_file_id??''}}" >
    ...
    <div class="col-md-6">
        <input class="form-control" name="attachment" type="text" id="attachment" value="{{ $order->attachment??''}}" >
