                                                ...
                                                <div class="media">
                                                    <div class="media-body">
                                                        <a href="http://lcm.thebackendprojects.com/filter/attorney">
                                                            <h3 class="info-count text-left">{{$allAttorney}} <span class="pull-right">{{$activeAttorney}}</span>
                                                            </h3>
                                                ...
                                                <div class="media">
                                                    <div class="media-body">
                                                        <a href="http://lcm.thebackendprojects.com/filter/associate">
                                                            <h3 class="info-count text-left">{{$allAssociate}} <span class="pull-right">{{$activeAssociate}}</span>
                                                            </h3>
                                                ...
                                                <div class="media">
                                                    <div class="media-body">
                                                        <a href="http://lcm.thebackendprojects.com/client/client">
                                                            <h3 class="info-count text-left">{{$allClient}} <span class="pull-right">{{$activeClient}}</span>
                                                            </h3>
                            ...
                            <div class="inner_section_account_info">
                                ...
                                <div class="user_details_wrapper">
                                    <div class="user_image">
                                        <img src="{{ asset('storage/uploads/users/')}}/{{Auth::user()->profile->pic}}" alt="">
                                    </div>
                                ...
                                {{--<table class="table table-fixed sticker_table">--}}
                                    ...
                                    {{--@foreach($clients as $key=> $client)--}}
                                        {{--<tr>--}}
                                            ...
                                            {{--<td>{{$client->profile->next_of_kin??''}}</td>--}}
                                            {{--<td>${{$client->profile->salary??''}}</td>--}}
                                            {{--<td>{{$client->profile->marital_status??''}}</td>--}}
                                            {{--<td>{{$client->profile->id_number??''}}</td>--}}
                                            {{--<td>{{$client->attorneyOrAssociate->name??''}}</td>--}}
                                            {{--<td>--}}
                                ...
                                <div class="swiper-slide">
                                    <div class="inner_section_swiper_slide">
                                        <div class="white-box box_shadow">
                                            <div class="media">
                                                <div class="media-body">
                                                    {{--<h3 class="info-count text-left">{{$activeCase}}<span class="pull-right">{{$activeCase}}</span>--}}
                                                    <h3 class="info-count text-left">{{$active_cases??'0'}}<span class="pull-right"></span>
                                                    </h3>
                                ...
                                <div class="swiper-slide">
                                    <div class="inner_section_swiper_slide">
                                        <div class="white-box box_shadow">
                                            <div class="media">
                                                <div class="media-body">
                                                    <h3 class="info-count text-left">{{$complete_cases}} <span class="pull-right">{{$complete_cases}}</span>
                                                    </h3>
                                                    <p class="info-text text-left">Completed Cases</p>
                                ...
                                <div class="swiper-slide">
                                    <div class="inner_section_swiper_slide">
                                        <div class="white-box box_shadow">
                                            <div class="media">
                                                <div class="media-body">
                                                    <h3 class="info-count text-left">{{@$numberofclients}}<span class="pull-right">{{@$numberofclients}}</span>
                                                    </h3>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-fixed sticker_table" id="myTable">
                                            ...
                                            @foreach($client as $case)
                                                @foreach($case->clientCase as $item)
                                                    <tr>
                                                        <td>{{@$item->case_number??''}}</td>
                                                        <td>{{@$item->name_of_parties??''}}</td>
                                                        <td>{{@$item->attorney_associate_id->attorneyOrAssociate->name??''}}</td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            @foreach($item->typeOfMatters as $matter)
                                                                {{@$matter->caseTypeOfMatters->name??'No Data'}}<br>
                                                        @endforeach
                                                        <td>{!! (@$item->status??''==1)?"<badge class='label label-success'>Active</badge>":"<badge class='label label-success'>Completed</badge>" !!}</td>
         ...
         <div id="event_modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="POST" action="{{ url('/caseEvent/case-event') }}" accept-charset="UTF-8"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="select2 m-b-10 select2-multiple form-control" id="user_id" name="user_id[]"multiple="multiple">
                                    ...
                                    @foreach($attorneies as $attorney)
        ...
        var eventsArray = [
            ...
            @if(auth()->user()->hasRole('secretary'))
                @foreach($casefile as $item)
                    ...
                    @endphp
                    {
                        title: '{{$item->name_of_parties}} ',
                        start: '{{$nextCourtDate ?? ''}}',
                        time: '{{$item->courtAttendantsNote->check_in ??''}}',
                        location: '{{$item->courtAttendantsNote->category->title ??''}}',
                        description: '{{$description??''}}',
                        @if(!empty($item->courtAttendantsNote) && $nextCourtDate)
        ...
        @endforeach
            @else
                @foreach($casefile as $value)
                    @foreach($value->clientCase as $item)
                        @php
                            $nextCourtDate = null;
                            $backgroundColor = '';
                            if (!empty($item->courtAttendantsNote)) {
