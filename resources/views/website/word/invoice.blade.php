    ...
    <table>
        ...
        <tr>
            ...
            <td colspan="1" style="width: 150px">
                ...
                @foreach($lcm as $item)
                    <h5>Address: {{$item->profile->address}}</h5>
                    <h5>Phone: {{$item->contact}}</h5>
                    <h5>Email: {{$item->email}}</h5></td>
                @endforeach
            <td colspan="10"></td>
        </tr>
        ...
        <tr>
            <td colspan="1" style="width: 20%">
                <h5>Bill To:</h5>
                <h4 style="font-size:15px;margin: 0px;">Name: {{$caseinvoice->caseFile->client->name}}</h4>
                <h4 style="font-size:15px;margin: 0px;">Address: {{$caseinvoice->caseFile->client->profile->address}}</h4>
                <h4 style="font-size:15px;margin: 0px;">Email: {{$caseinvoice->caseFile->client->email}}</h4>
            </td>
            <td colspan="10" style="width: 60%"></td>
            <td colspan="1" style="width:100px;">
                <table style="width:100px;text-align:right;">
                    <tbody>
                    <tr>
                        <td style="width:100px;text-align:right;"><h5>Date:</h5></td>
                        <td style="text-align:right;"><h5>{{ date('d-M-Y', strtotime($caseinvoice->date)) }}</h5></td>
                    </tr>
                    <tr>
                        <td style="text-align:right;"><h5>VAT No:</h5></td>
                        <td style="text-align:right;"><h5>{{ $caseinvoice->vat_number }}</h5></td>
                    </tr>
                    <tr>
                        <td style="text-align:right;"><h5>Invoice No:</h5></td>
                        <td style="text-align:right;"><h5>{{ $caseinvoice->invoice_number }}</h5></td>
                    </tr>
                    </tbody>
                </table>
            </td>
        ...
        <tr>
            <td colspan="12">
                <table class="second_table">
                            ...
                            <div style="padding-left:20px;padding-bottom:20px;">
                                <table style="border-collapse: collapse;border:0px!important;">
                                    ...
                                    <tr>
                                        ...
                                        <td>${{ $caseinvoice->senior_counsel_fees }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            Junior Counsel:
                                        </td style="min-width:150px;">
                                        <td>${{ $caseinvoice->junior_counsel_fees }}</td>
                                    </tr>
                                    <tr>
                                        <td style="min-width:150px;">
                                            Instructing Attorney:
                                        </td>
                                        <td>${{ $caseinvoice->instructing_attorney_fees }}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    {{--<tr>--}}
                        {{--<td></td>--}}
                        {{--<td colspan="3" style="text-align:left;padding-left:10px;">Sub Total</td>--}}
                        {{--<td>$300,000</td>--}}
                    {{--</tr>--}}
                    <tr>
                        <td></td>
                        <td colspan="2" style="text-align:left;padding-left:10px;">VAT %</td>
        ...
        <tr>
            <td style="border-bottom:1px dashed black;width:200px;padding-top: 20px;">
                {{-- Add signature here --}}
                <img style="width: 100%;" src="{{ $caseinvoice->signature }}" alt="">
