                                    ...
                                    @foreach($roles as $key=>$role)
                                        <tr>
                                            ...
                                            <th>
                                                ...
                                                @if($role->name=='admin')
                                                    &nbsp;&nbsp;<button class="delete btn btn-danger btn-sm" href="#" disabled><i class="fa fa-trash-o"></i> Delete</button>
                                                @elseif($role->name=='user')
                                                    &nbsp;&nbsp;<button class="delete btn btn-danger btn-sm" href="#" disabled><i class="fa fa-trash-o"></i> Delete</button>
                                                @else
                                                    &nbsp;&nbsp;<a class="delete btn btn-danger btn-sm" href="{{url('role/delete/'.$role->id)}}"><i class="fa fa-trash-o"></i> Delete</a>
                                                @endif
                                            </th>
                                        </tr>
                                    @endforeach
